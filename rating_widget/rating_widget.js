...
var BDRatingStars = Backbone.View.extend({
    ...
    render : function() {
        ...
        var html = [];
        var radioHtml = [];
        //I know... I really should use Handlebars or a templating engine for this.
...
var TestView = Backbone.View.extend({
    ...
    initialize : function() {
        this._rater = new BDRatingStars({
            el : '#raterBox',
            scale : 10,
            name : this.cid + '_rater',
            titles : ['Freezing','Cold','Normal','Warm','Hot','Freezing','Cold','Normal','Warm','Hot']
        });
...
$(function() {
    /*
     ...
     scale : 5,
     name : 'myRaterBox1',
     titles : ['Poor','Okay','Good','Excellent','Best']
     });
     */
    new TestView();
});